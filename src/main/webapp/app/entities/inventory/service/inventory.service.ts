...
export class InventoryService {
  ...
  update(inventory: IInventory): Observable<EntityResponseType> {
    return this.http.put<IInventory>(`${this.resourceUrl}/${this.getInventoryIdentifier(inventory)}`, inventory, { observe: 'response' });
  }

  partialUpdate(inventory: PartialUpdateInventory): Observable<EntityResponseType> {
    return this.http.patch<IInventory>(`${this.resourceUrl}/${this.getInventoryIdentifier(inventory)}`, inventory, { observe: 'response' });
  }
